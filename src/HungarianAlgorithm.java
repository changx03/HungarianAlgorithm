...
/**
 *   Created by Luke Chang on 30/11/2016.
 *
 *   An implementation of the Hungarian Algorithm for solving the assignment problem.
 *   The matrix[i][j] where i is equal to j.
 *   The time complexity is O(n^3).
 *
 *   The cost matrix, costMat, records how many zeros the current position is connected.
 *   the cost is -1, if the current position isn't zero.
 */
